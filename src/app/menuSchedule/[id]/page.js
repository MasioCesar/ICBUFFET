...
import { saveReservation, setRegisterReservation } from "@/lib/setFirebase";
...
export default function MenuSchedule({ params }) {
  ...
  const [mesaUid, setMesaUid] = useState(null);


  useEffect(() => {
    const storedMesaUid = localStorage.getItem("mesaUid"); // Recupera o mesaUid
    setMesaUid(storedMesaUid);
  }, []);
